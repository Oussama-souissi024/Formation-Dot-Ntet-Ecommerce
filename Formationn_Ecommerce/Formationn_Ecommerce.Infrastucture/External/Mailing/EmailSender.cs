...
namespace Formationn_Ecommerce.Infrastucture.External.Mailing
{
    public class EmailSender : IEmailSender
    {
        ...
        public async Task SendEmailConfirmationAsync(string email, string confirmationToken, string userId)
        {
            ...
            var confirmationLink = $"https://localhost:7017/Auth/ConfirmEmail?token={encodedToken}&userId={userId}";
        ...
        public async Task SendPasswordResetEmailAsync(string email, string resetToken, string userId)
        {
            ...
            var resetLink = $"https://localhost:7017/Auth/ResetPassword?token={encodedToken}&userId={userId}";
            var message = new EmailMessage
            {
                To = email,
                ...
                Body = $@"
                    ...
                    <body style=""font-family: Arial, sans-serif; line-height: 1.6;"">
                        <div style=""max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e4e4e4; border-radius: 5px;"">
                            ...
                            <div style=""text-align: center; margin: 30px 0;"">
                                <a href='https://localhost:7017/' style=""display: inline-block; background-color: #4CAF50; color: white; padding: 12px 20px; text-decoration: none; border-radius: 4px;"">
